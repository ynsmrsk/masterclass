...
export default function Hero() {
  ...
  return (
    ...
    >
      ...
      >
        <h1 className="mb-6 text-4xl lg:text-6xl xl:text-[100px] drop-shadow-lg text-balance tracking-tight max-w-screen-2xl">Estetik ve Fotogerçekçiliği Birleştiren Mimari Görselleştirme Kursu</h1>
