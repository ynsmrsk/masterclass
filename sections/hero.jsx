...
export default function Hero() {
  ...
  return (
    ...
    >
      ...
      >
        <h1 className="mb-6 text-4xl lg:text-6xl xl:text-7xl 2xl:text-[100px] drop-shadow-lg text-balance tracking-tight max-w-screen-2xl">Estetik ve Fotogerçekçiliği Birleştiren Mimari Görselleştirme Kursu</h1>
        ...
        <div className="flex gap-4 items-center mt-10">
          ...
          <button
            className="flex items-center gap-2 px-6 py-1 bg-dark text-light rounded-full border-[1px] border-light"
            onClick={() => {
      ...
      <dialog
        className="bg-dark m-0 max-w-[100vw] max-h-[100vh] h-screen animate-fadeout [&[open]]:animate-fadein"
        ref={dialogRef}
        onClose={() => {
