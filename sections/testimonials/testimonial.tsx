    ...
    return (
        <div className="px-4 lg:px-12 py-3 lg:py-8 flex flex-col items-start gap-4 sm:gap-8 border sm:border-2 border-primary-700 rounded-md">
            ...
            <a
                ...
                rel="noreferrer"
            >
                <Image className="rounded grayscale-[20%]" src={testimonial.image} width={44} height={44} alt='Reviewer' />
                <div className="flex flex-col font-medium">
                    <span className="text-primary-800 leading-tight text-sm sm:text-base 2xl:text-lg 2xl:leading-tight uppercase">{testimonial.student}</span>
                    <span className="text-primary-600 text-sm leading-tight 2xl:text-base 2xl:leading-tight">@{testimonial.instagram}</span>
                </div>
            </a>
        </div>
    )
